...
public class Forest {
    ...
    void trainForest() throws IOException {
        ...
        cpos = trainfiles/2;
        cneg = trainfiles/2;
        System.out.print("Give me the attributes: ");
        ...
        System.out.println("We use 5 trees with example size " + trainfiles/2 + " and "+(attr.size() - attr.size() / 4)+ " atrributes." );
        ...
        for (int i = 0; i < 5; i++) {
            ...
            test.putAll(item.loadTest(testfiles,path));
            forest.add(item);
            item = new ID3();
        }
    }
    ...
    void testForest() throws IOException {
        ...
        System.out.println("The accurasy is : "+accuracy);
    }
}
